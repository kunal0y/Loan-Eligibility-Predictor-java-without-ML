...
public class Regs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/minipro/MiniPro/wordpress-registration-form-1024x512.png"))); // NOI18N
        ...
        jLabel13.setFont(new java.awt.Font("Niagara Solid", 1, 72)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cpaswd=new String(jPasswordField2.getPassword());
        ...
        if (!paswd.matches("^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*()_+\\-=\\[\\]{};':\"\\\\|,.<>\\/?]).{8}$")) {
        ...
        try {
            ...
            String query = "insert into reg values('"+name+"','"+num+"','"+mail+"','"+uname+"','"+paswd+"')";
